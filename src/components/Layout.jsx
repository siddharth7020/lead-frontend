      ...
      >
        <div className="p-4 flex items-center justify-between">
          ...
          <button onClick={() => setIsOpen(!isOpen)} className="text-white">
            {isOpen ? '◄' : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-kanban-fill" viewBox="0 0 16 16">
        ...
        <nav className="flex-1">
          <Link to="/" className="block p-4 hover:bg-indigo-700">
            {isOpen ? 'Dashboard' : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash-square-fill" viewBox="0 0 16 16">
          ...
          <Link to="/leads" className="block p-4 hover:bg-indigo-700">
            {isOpen ? 'Leads' : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-text" viewBox="0 0 16 16">
          ...
          {user?.role === 'super_admin' && (
            <Link to="/users" className="block p-4 hover:bg-indigo-700">
              {isOpen ? 'Users' : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
        ...
        <button onClick={handleLogout} className="p-4 hover:bg-indigo-700 text-left">
          {isOpen ? 'Logout' : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
